...
map.getView().fit([218748.739231, 796003.575378, 226909.368517, 801487.869253], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Stations & Marchés Abomey</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (93 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Cette carte présente l\'emplacement des stations-service et des marché dans la ville d\'abomey.';
            }
